...
*/
    ...
    oneway void remote_mkdir(1:HostID sender, 2:string path, 3:mode_t mode);
    oneway void remote_unlink(1:HostID sender, 2:string path);
    oneway void remote_rmdir(1:HostID sender, 2:string path);
    oneway void remote_symlink(1:HostID sender, 2:string from, 3:to);
    oneway void remote_rename(1:HostID sender, 2:string from, 3:to);
    oneway void remote_link(1:HostID sender, 2:from, 3:to);
    oneway void remote_chmod(1:HostID sender, 2:string path, 3:i32 mode);
    oneway void remote_chown(1:HostID sender, 2:string path, 3:i32 uid, 3:i32 gid);
    ...
    oneway void remote_create(1:HostID sender, 2:string path, mode_t mode, 4:FUSEFileInfoTransport fi);
